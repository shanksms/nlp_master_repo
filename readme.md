...
![\Large \frac{P(pos)}{P(Neg)}\prod_{i=1}_{m}\frac{P({W}_{i} | Pos)}{P({W}_{i} | Neg)}>1](https://latex.codecogs.com/svg.latex?\Large&space;\frac{P(pos)}{P(Neg)}\prod_{i=1}_{m}\frac{P({W}_{i}|Pos)}{P({W}_{i}|Neg)}>1)  
